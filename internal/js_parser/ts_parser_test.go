...
func TestTSArrow(t *testing.T) {
	...
	// https://github.com/txix-open/esbuild/issues/4027
...
func TestTSInstantiationExpression(t *testing.T) {
	...
	// See: https://github.com/txix-open/esbuild/issues/2201
...
func TestTSES5(t *testing.T) {
	...
	// function return type. See: https://github.com/txix-open/esbuild/issues/2375.
