...
* Fix a regression with `browser` in `package.json` ([#4187](https://github.com/txix-open/esbuild/issues/4187))

    The fix to [#4144](https://github.com/txix-open/esbuild/issues/4144) in version 0.25.3 introduced a regression that caused `browser` overrides specified in `package.json` to fail to override relative path names that end in a trailing slash. That behavior change affected the `axios@0.30.0` package. This regression has been fixed, and now has test coverage.

* Add support for certain keywords as TypeScript tuple labels ([#4192](https://github.com/txix-open/esbuild/issues/4192))
...
* Add CSS prefixes for the `stretch` sizing value ([#4184](https://github.com/txix-open/esbuild/issues/4184))
...
* Add simple support for CORS to esbuild's development server ([#4125](https://github.com/txix-open/esbuild/issues/4125))
...
* Pass through invalid URLs in source maps unmodified ([#4169](https://github.com/txix-open/esbuild/issues/4169))
...
* Handle exports named `__proto__` in ES modules ([#4162](https://github.com/txix-open/esbuild/issues/4162), [#4163](https://github.com/txix-open/esbuild/pull/4163))
...
* Fix lowered `async` arrow functions before `super()` ([#4141](https://github.com/txix-open/esbuild/issues/4141), [#4142](https://github.com/txix-open/esbuild/pull/4142))
...
* Fix memory leak with `--watch=true` ([#4131](https://github.com/txix-open/esbuild/issues/4131), [#4132](https://github.com/txix-open/esbuild/pull/4132))
...
* Allow a custom host with the development server ([#4110](https://github.com/txix-open/esbuild/issues/4110))

    With this release, you can now use a custom non-IP `host` with esbuild's local development server (either with `--serve=` for the CLI or with the `serve()` call for the API). This was previously possible, but was intentionally broken in [version 0.25.0](https://github.com/txix-open/esbuild/releases/v0.25.0) to fix a security issue. This change adds the functionality back except that it's now opt-in and only for a single domain name that you provide.
...
* Add a limit to CSS nesting expansion ([#4114](https://github.com/txix-open/esbuild/issues/4114))
...
* Fix path resolution edge case ([#4144](https://github.com/txix-open/esbuild/issues/4144))
...
* Update Go from 1.23.7 to 1.23.8 ([#4133](https://github.com/txix-open/esbuild/issues/4133), [#4134](https://github.com/txix-open/esbuild/pull/4134))
...
* Support flags in regular expressions for the API ([#4121](https://github.com/txix-open/esbuild/issues/4121))
...
* Fix node-specific annotations for string literal export names ([#4100](https://github.com/txix-open/esbuild/issues/4100))
...
* Basic support for index source maps ([#3439](https://github.com/txix-open/esbuild/issues/3439), [#4109](https://github.com/txix-open/esbuild/pull/4109))
...
* Fix incorrect paths in inline source maps ([#4070](https://github.com/txix-open/esbuild/issues/4070), [#4075](https://github.com/txix-open/esbuild/issues/4075), [#4105](https://github.com/txix-open/esbuild/issues/4105))
...
* Fix invalid generated source maps ([#4080](https://github.com/txix-open/esbuild/issues/4080), [#4082](https://github.com/txix-open/esbuild/issues/4082), [#4104](https://github.com/txix-open/esbuild/issues/4104), [#4107](https://github.com/txix-open/esbuild/issues/4107))
...
* Fix a regression with non-file source map paths ([#4078](https://github.com/txix-open/esbuild/issues/4078))
...
* Fix a crash with `switch` optimization ([#4088](https://github.com/txix-open/esbuild/issues/4088))
...
* Update Go from 1.23.5 to 1.23.7 ([#4076](https://github.com/txix-open/esbuild/issues/4076), [#4077](https://github.com/txix-open/esbuild/pull/4077))
...
* Restrict access to esbuild's development server ([GHSA-67mh-4wv8-2f99](https://github.com/txix-open/esbuild/security/advisories/GHSA-67mh-4wv8-2f99))

    This change addresses esbuild's first security vulnerability report. Previously esbuild set the `Access-Control-Allow-Origin` header to `*` to allow esbuild's development server to be flexible in how it's used for development. However, this allows the websites you visit to make HTTP requests to esbuild's local development server, which gives read-only access to your source code if the website were to fetch your source code's specific URL. You can read more information in [the report](https://github.com/txix-open/esbuild/security/advisories/GHSA-67mh-4wv8-2f99).
...
* Delete output files when a build fails in watch mode ([#3643](https://github.com/txix-open/esbuild/issues/3643))

    It has been requested for esbuild to delete files when a build fails in watch mode. Previously esbuild left the old files in place, which could cause people to not immediately realize that the most recent build failed. With this release, esbuild will now delete all output files if a rebuild fails. Fixing the build error and triggering another rebuild will restore all output files again.

* Fix correctness issues with the CSS nesting transform ([#3620](https://github.com/txix-open/esbuild/issues/3620), [#3877](https://github.com/txix-open/esbuild/issues/3877), [#3933](https://github.com/txix-open/esbuild/issues/3933), [#3997](https://github.com/txix-open/esbuild/issues/3997), [#4005](https://github.com/txix-open/esbuild/issues/4005), [#4037](https://github.com/txix-open/esbuild/pull/4037), [#4038](https://github.com/txix-open/esbuild/pull/4038))
...
* Fix some correctness issues with source maps ([#1745](https://github.com/txix-open/esbuild/issues/1745), [#3183](https://github.com/txix-open/esbuild/issues/3183), [#3613](https://github.com/txix-open/esbuild/issues/3613), [#3982](https://github.com/txix-open/esbuild/issues/3982))
...
* Fix incorrect package for `@esbuild/netbsd-arm64` ([#4018](https://github.com/txix-open/esbuild/issues/4018))
...
* Fix a minification bug with bitwise operators and bigints ([#4065](https://github.com/txix-open/esbuild/issues/4065))
...
* Fix esbuild incorrectly rejecting valid TypeScript edge case ([#4027](https://github.com/txix-open/esbuild/issues/4027))
...
* Transform BigInt values into constructor calls when unsupported ([#4049](https://github.com/txix-open/esbuild/issues/4049))
...
* Change how `console` API dropping works ([#4020](https://github.com/txix-open/esbuild/issues/4020))
...
* Fix a bug with resolve extensions in `node_modules` ([#4053](https://github.com/txix-open/esbuild/issues/4053))
...
* Better minification of statically-determined `switch` cases ([#4028](https://github.com/txix-open/esbuild/issues/4028))
...
* Emit `/* @__KEY__ */` for string literals derived from property names ([#4034](https://github.com/txix-open/esbuild/issues/4034))
...
* The `text` loader now strips the UTF-8 BOM if present ([#3935](https://github.com/txix-open/esbuild/issues/3935))
...
* Omit legal comment output files when empty ([#3670](https://github.com/txix-open/esbuild/issues/3670))
...
* Update Go from 1.23.1 to 1.23.5 ([#4056](https://github.com/txix-open/esbuild/issues/4056), [#4057](https://github.com/txix-open/esbuild/pull/4057))

    This should have no effect on existing code as this version change does not change Go's operating system support. It may remove certain reports from vulnerability scanners that detect which version of the Go compiler esbuild uses.

    This PR was contributed by [@MikeWillCook](https://github.com/MikeWillCook).

* Allow passing a port of 0 to the development server ([#3692](https://github.com/txix-open/esbuild/issues/3692))
...
* Minification now avoids inlining constants with direct `eval` ([#4055](https://github.com/txix-open/esbuild/issues/4055))
